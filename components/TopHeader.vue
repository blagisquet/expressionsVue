  ...
  <header class="top-header util__flex util__container">
    <nav class="top-header__col">
      <ul class="nav">
        ...
        <li>
          <nuxt-link class="nav__item" to="/en/expressions">Expressions</nuxt-link>
        </li>
      </ul>
    </nav>
    ...
    <nav class="top-header__col top-header__second-navi">
      <ul class="nav">
        <li>
          <nuxt-link class="nav__item" to="/en/expressions">English</nuxt-link>
        </li>
        <li>
          <nuxt-link class="nav__item" to="/fr/expressions">French</nuxt-link>
        </li>
      </ul>
    </nav>
  </header>
